...
static int musig2_set_parsig(musig2_context_sig *mcs, unsigned char *partial_signature, unsigned char b_LIST[V][MUSIG2_SCALAR_BYTES], unsigned char *a, unsigned char *c, int R_parity) {
    int j;
